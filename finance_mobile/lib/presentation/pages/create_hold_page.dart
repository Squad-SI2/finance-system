...
class CreateHoldPage extends StatefulWidget {
  const CreateHoldPage({super.key});

  @override
  State<CreateHoldPage> createState() => _CreateHoldPageState();
}

class _CreateHoldPageState extends State<CreateHoldPage> {
  ...
  void _onViewModelChanged() {
    ...
    if (_viewModel.transactionCreated) {
      ...
      _showSnackBar('Hold creado exitosamente', isError: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bloquear Fondos (Hold)'),
