...
public class SampleDataBootstrapService {
    ...
    private void seedTenantBundle(TenantSeed seed, PlatformTenantResponse tenant) {
        ...
        runOptionalSeedStep("rich activity", seed.slug(), () -> seedRichActivity(
                schemaName,
                seed,
                ownerUserId,
                ownerAccountId,
    ...
    private List<TenantSeed> sampleTenants() {
        return List.of(
                ...
                new TenantSeed("Inti Bank", "inti-bank", "DEMO", "rodrigo@gmail.com", "Rodrigo", "Aguilar", "valeria@gmail.com", "Valeria", "Cruz", "INTI", "ELECTRICITY_CRE", "INTI-6611", "Av. Banzer", "Energía oficina", new BigDecimal("3200.00"), new BigDecimal("740.00")),
                new TenantSeed("Quri Pay", "quri-pay", "BASIC", "fernando@gmail.com", "Fernando", "Salinas", "noelia@gmail.com", "Noelia", "Bustos", "QURI", "WATER_SAGUAPAC", "QURI-7720", "Equipetrol", "Agua hogar", new BigDecimal("1680.00"), new BigDecimal("455.00")),
                new TenantSeed("Yana Wallet", "yana-wallet", "DEMO", "alejandro@gmail.com", "Alejandro", "Montano", "paola@gmail.com", "Paola", "Severiche", "YANA", "TV_TIGO", "YANA-8830", "Plan 3000", "TV familiar", new BigDecimal("2750.00"), new BigDecimal("620.00")),
                new TenantSeed("Sumaq Finance", "sumaq-finance", "BASIC", "ignacio@gmail.com", "Ignacio", "Velasco", "rocio@gmail.com", "Rocio", "Arce", "SUMAQ", "INTERNET_ENTEL", "SUMAQ-9940", "Las Palmas", "Internet fibra", new BigDecimal("1980.00"), new BigDecimal("520.00"))
        );
    }
