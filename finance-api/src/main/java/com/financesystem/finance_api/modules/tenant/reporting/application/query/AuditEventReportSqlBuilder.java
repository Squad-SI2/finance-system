...
@Component
public class AuditEventReportSqlBuilder {

    private final ReportTemplate template;

    public AuditEventReportSqlBuilder(AuditEventsReportTemplateProvider provider) {
        this.template = provider.getTemplate();
    }

    public ReportSqlQuery buildAnalytic(RunAnalyticAuditEventsReportRequest request) {
        Objects.requireNonNull(request, "request must not be null");
        List<AuditEventReportColumnKey> columns = request.columns();
    ...
    public ReportSqlQuery buildManagerial(RunManagerialAuditEventsReportRequest request) {
        Objects.requireNonNull(request, "request must not be null");
        List<AuditEventReportGroupByKey> groupBy = request.groupBy();
        List<AuditEventReportMetricKey> metrics = request.metrics();
    ...
    private void appendWhere(StringBuilder sql, List<Object> parameters, List<AuditEventReportFilterRequest> filters) {
    ...
    private void appendGroupBy(StringBuilder sql, List<AuditEventReportGroupByKey> groupBy, Map<String, ReportField> fieldsByKey) {
        sql.append(" GROUP BY ");
    ...
    private void appendOrderBy(StringBuilder sql, Map<String, ReportField> fieldsByKey, List<?> sortItems) {
        ...
        for (Object sortItem : sortItems) {
            if (sortItem instanceof AuditEventReportSortRequest analyticSort) {
            ...
            } else if (sortItem instanceof AuditEventReportManagerialSortRequest managerialSort) {
    ...
    private String metricSelectExpression(AuditEventReportMetricKey metricKey) {
