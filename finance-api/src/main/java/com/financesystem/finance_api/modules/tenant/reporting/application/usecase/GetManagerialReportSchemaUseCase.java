...
public class GetManagerialReportSchemaUseCase {
    ...
    public ReportSchemaResponse execute(ReportType reportType) {
        return reportSchemaBuilder.build(reportTemplateRegistry.getTemplate(reportType), ReportMode.MANAGERIAL);
    }
}
