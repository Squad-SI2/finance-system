...
import com.financesystem.finance_api.modules.tenant.reporting.domain.model.operationfees.OperationFeeReportColumnKey;
...
public record RunAnalyticOperationFeeReportRequest(
        @NotNull ReportType reportType,
        @NotEmpty List<OperationFeeReportColumnKey> columns,
        List<@Valid OperationFeeReportFilterRequest> filters,
        List<@Valid OperationFeeReportSortRequest> sort,
