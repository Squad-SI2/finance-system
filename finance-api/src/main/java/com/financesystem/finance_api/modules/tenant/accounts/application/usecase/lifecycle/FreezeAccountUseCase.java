...
public class FreezeAccountUseCase {
    ...
    private static final Logger log = LoggerFactory.getLogger(FreezeAccountUseCase.class);
    ...
    public AccountOwnerResponse execute(UUID accountId, String reason) {
        ...
        ObjectNode data = objectMapper.createObjectNode()
                ...
                .put("status", AccountStatus.FROZEN.name())
        ...
        publishNotificationSafely(new NotificationPublishRequest(
                ...
                "Account frozen",
                "Your account " + savedAccount.accountNumber() + " has been frozen.",
                data,
                null,
    ...
    private void publishNotificationSafely(NotificationPublishRequest request) {
        try {
            ...
            log.warn("Unable to publish account frozen notification: {}", exception.getMessage());
        }
    }
}
