...
@Component
public class OperationFeeReportSqlBuilder {

    private final ReportTemplate template;

    public OperationFeeReportSqlBuilder(OperationFeesReportTemplateProvider provider) {
        this.template = provider.getTemplate();
    }

    public ReportSqlQuery buildAnalytic(RunAnalyticOperationFeeReportRequest request) {
        Objects.requireNonNull(request, "request must not be null");
        List<OperationFeeReportColumnKey> columns = request.columns();
    ...
    public ReportSqlQuery buildManagerial(RunManagerialOperationFeeReportRequest request) {
        Objects.requireNonNull(request, "request must not be null");
        List<OperationFeeReportGroupByKey> groupBy = request.groupBy();
        List<OperationFeeReportMetricKey> metrics = request.metrics();
    ...
    private void appendWhere(StringBuilder sql, List<Object> parameters, List<OperationFeeReportFilterRequest> filters) {
    ...
    private void appendGroupBy(StringBuilder sql, List<OperationFeeReportGroupByKey> groupBy, Map<String, ReportField> fieldsByKey) {
        sql.append(" GROUP BY ");
    ...
    private void appendOrderBy(StringBuilder sql, Map<String, ReportField> fieldsByKey, List<?> sortItems) {
        ...
        for (Object sortItem : sortItems) {
            if (sortItem instanceof OperationFeeReportSortRequest analyticSort) {
            ...
            } else if (sortItem instanceof OperationFeeReportManagerialSortRequest managerialSort) {
    ...
    private String metricSelectExpression(OperationFeeReportMetricKey metricKey) {
