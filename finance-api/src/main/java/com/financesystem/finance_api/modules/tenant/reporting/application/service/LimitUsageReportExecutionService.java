...
import com.financesystem.finance_api.modules.tenant.reporting.application.query.LimitUsageReportSqlBuilder;
import com.financesystem.finance_api.modules.tenant.reporting.application.query.ReportSqlQuery;
import com.financesystem.finance_api.modules.tenant.reporting.application.validator.LimitUsageReportRequestValidator;
...
@Service
public class LimitUsageReportExecutionService {

    private final LimitUsageReportTemplateProvider templateProvider;
    private final LimitUsageReportRequestValidator validator;
    private final LimitUsageReportSqlBuilder sqlBuilder;
    ...
    public LimitUsageReportExecutionService(
            LimitUsageReportTemplateProvider templateProvider,
            LimitUsageReportRequestValidator validator,
            LimitUsageReportSqlBuilder sqlBuilder,
    ...
    @Transactional
    public ReportResultResponse executeAnalytic(RunAnalyticLimitUsageReportRequest request) {
        return executeAnalytic(request, null);
    }

    @Transactional
    public ReportResultResponse executeAnalytic(RunAnalyticLimitUsageReportRequest request, UUID sourceExecutionId) {
    ...
    @Transactional
    public ReportResultResponse executeManagerial(RunManagerialLimitUsageReportRequest request) {
        return executeManagerial(request, null);
    }

    @Transactional
    public ReportResultResponse executeManagerial(RunManagerialLimitUsageReportRequest request, UUID sourceExecutionId) {
        Instant generatedAt = Instant.now();
        validateExportPermission(request.outputs());
        try {
    ...
    private List<ReportColumnResponse> resolveAnalyticColumns(List<LimitUsageReportColumnKey> requestedColumns) {
        List<ReportColumnResponse> columns = new ArrayList<>();
        for (LimitUsageReportColumnKey key : requestedColumns) {
    ...
    private List<ReportColumnResponse> resolveManagerialColumns(
        ...
        for (LimitUsageReportMetricKey key : metrics) {
    ...
    private List<String> summarizeFilters(List<LimitUsageReportFilterRequest> filters) {
    ...
    private List<String> resolveGroupByLabels(List<LimitUsageReportGroupByKey> groupBy) {
    ...
    private List<String> resolveMetricLabels(List<LimitUsageReportMetricKey> metrics) {
    ...
    private List<ReportOutput> extractOutputs(Object request) {
        if (request instanceof RunAnalyticLimitUsageReportRequest analyticRequest) {
            return analyticRequest.outputs();
        }
        if (request instanceof RunManagerialLimitUsageReportRequest managerialRequest) {
    ...
    private Integer extractLimit(Object request) {
        if (request instanceof RunAnalyticLimitUsageReportRequest analyticRequest && analyticRequest.pagination() != null) {
            return analyticRequest.pagination().limit();
        }
        if (request instanceof RunManagerialLimitUsageReportRequest managerialRequest && managerialRequest.pagination() != null) {
