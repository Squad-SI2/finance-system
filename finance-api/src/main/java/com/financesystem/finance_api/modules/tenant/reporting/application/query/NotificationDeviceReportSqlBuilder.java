...
@Component
public class NotificationDeviceReportSqlBuilder {

    private final ReportTemplate template;

    public NotificationDeviceReportSqlBuilder(NotificationDevicesReportTemplateProvider provider) {
        this.template = provider.getTemplate();
    }

    public ReportSqlQuery buildAnalytic(RunAnalyticNotificationDevicesReportRequest request) {
        Objects.requireNonNull(request, "request must not be null");
        List<NotificationDeviceReportColumnKey> columns = request.columns();
    ...
    public ReportSqlQuery buildManagerial(RunManagerialNotificationDevicesReportRequest request) {
        Objects.requireNonNull(request, "request must not be null");
        List<NotificationDeviceReportGroupByKey> groupBy = request.groupBy();
        List<NotificationDeviceReportMetricKey> metrics = request.metrics();
    ...
    private void appendWhere(StringBuilder sql, List<Object> parameters, List<NotificationDeviceReportFilterRequest> filters) {
    ...
    private void appendGroupBy(StringBuilder sql, List<NotificationDeviceReportGroupByKey> groupBy, Map<String, ReportField> fieldsByKey) {
        sql.append(" GROUP BY ");
    ...
    private void appendOrderBy(StringBuilder sql, Map<String, ReportField> fieldsByKey, List<?> sortItems) {
        ...
        for (Object sortItem : sortItems) {
            if (sortItem instanceof NotificationDeviceReportSortRequest analyticSort) {
            ...
            } else if (sortItem instanceof NotificationDeviceReportManagerialSortRequest managerialSort) {
    ...
    private String metricSelectExpression(NotificationDeviceReportMetricKey metricKey) {
