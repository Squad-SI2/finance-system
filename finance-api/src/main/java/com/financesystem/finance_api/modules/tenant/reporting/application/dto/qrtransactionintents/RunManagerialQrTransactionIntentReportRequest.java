...
import com.financesystem.finance_api.modules.tenant.reporting.domain.model.qrtransactionintents.QrTransactionIntentReportGroupByKey;
...
public record RunManagerialQrTransactionIntentReportRequest(
        @NotNull
        ReportType reportType,
        @NotEmpty
        List<QrTransactionIntentReportGroupByKey> groupBy,
        @NotEmpty
        List<QrTransactionIntentReportMetricKey> metrics,
        List<@Valid QrTransactionIntentReportFilterRequest> filters,
        List<@Valid QrTransactionIntentReportManagerialSortRequest> sort,
        @NotNull
        @Valid
