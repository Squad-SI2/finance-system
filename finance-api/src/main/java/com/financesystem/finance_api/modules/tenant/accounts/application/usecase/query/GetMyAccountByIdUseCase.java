...
public class GetMyAccountByIdUseCase {
    ...
    public AccountOwnerResponse execute(UUID accountId) {
        ...
        AccountOwnerView account = accountRepository.findViewById(accountId)
        ...
        return accountMapper.toOwnerResponse(account);
    }
}
