...
@Component({
  ...
  template: `
    <section class="relative overflow-hidden bg-[#F3FAF1]">
      <div class="absolute left-1/2 top-0 h-[520px] w-[520px] -translate-x-1/2 rounded-full bg-white/70 blur-3xl"></div>

      <div class="relative mx-auto grid max-w-7xl gap-12 px-4 pb-16 pt-12 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8 lg:pb-20 lg:pt-16">
        <div class="flex flex-col justify-center">
          <div class="mb-8 inline-flex w-fit items-center gap-2 rounded-full border border-[#C8E6C9] bg-white px-5 py-2 text-xs font-black uppercase tracking-[0.22em] text-[#2E7D32] shadow-sm">
            <lucide-icon name="sparkles" class="h-4 w-4"></lucide-icon>
            Guías rápidas y acceso seguro
          </div>

          <h1 class="max-w-4xl text-5xl font-black leading-[0.98] tracking-tight text-[#083B16] sm:text-6xl lg:text-7xl">
        ...
        <div class="flex items-center">
          <div class="w-full rounded-[32px] border border-[#D6E8D1] bg-white/90 p-8 shadow-[0_30px_90px_rgba(27,94,32,0.12)]">
            <div class="flex items-start justify-between gap-6">
              <div>
                <p class="text-sm font-black uppercase tracking-[0.24em] text-[#7A8C7C]">Inicio rápido</p>
                <h2 class="mt-4 text-3xl font-black leading-tight text-[#083B16]">
                  Aprende lo básico y entra con seguridad
                </h2>
              </div>

              <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[#E8F5E9] text-[#2E7D32]">
            ...
            <div class="mt-8 space-y-5">
              <div class="rounded-2xl border border-[#D6E8D1] bg-[#FAFCF8] p-5">
                <p class="text-xs font-black uppercase tracking-[0.22em] text-[#7A8C7C]">01. Acceso seguro</p>
                <p class="mt-3 text-sm leading-7 text-[#49624D]">
                  Ingresa con contraseña o con rostro, según tu configuración y el tenant activo.
                </p>
              </div>

              <div class="rounded-2xl border border-[#D6E8D1] bg-[#FAFCF8] p-5">
                <p class="text-xs font-black uppercase tracking-[0.22em] text-[#7A8C7C]">02. Pagos de servicios</p>
                <p class="mt-3 text-sm leading-7 text-[#49624D]">
                  Consulta, paga y revisa tus pagos de servicios desde una sola interfaz.
                </p>
              </div>

              <div class="rounded-2xl border border-[#D6E8D1] bg-[#FAFCF8] p-5">
                <p class="text-xs font-black uppercase tracking-[0.22em] text-[#7A8C7C]">03. Tu perfil</p>
                <p class="mt-3 text-sm leading-7 text-[#49624D]">
                  Actualiza tu foto, usa cámara o galería y activa login facial si lo necesitas.
                </p>
              </div>
            </div>
