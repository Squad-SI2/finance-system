...
@Component({
  selector: 'app-tenant-service-payment-table',
  standalone: true,
          ...
          <tbody class="divide-y divide-[#E8F2E2] bg-white">
            ...
            <tr *ngIf="payments.length === 0">
              <td colspan="8" class="px-5 py-10 text-center">
                <p class="text-sm font-semibold text-[#1B5E20]">No hay pagos de servicios registrados</p>
                <p class="mt-1 text-sm text-[#6B7D6C]">Cuando se realicen pagos por app o ventanilla aparecerán aquí.</p>
              </td>
            </tr>
          </tbody>
        </table>
...
export class TenantServicePaymentTableComponent {
